...
public class MainActivity extends Activity {
    ...
    //String[] stations = {"Европа Плюс","Ретро FM", "Радио NS", "Тенгри FM", "Energy FM", "Nostalgie Almaty","Russian FM","Radio Metro" };
    public AQuery aq;
        ...
        switch (v.getId()) {
          ...
          //  case R.id.button7:
            ...
            case R.id.button5:
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    fTrans.replace(R.id.frgmCont2,frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=energyfm";
                    aq.ajax(apiURL, JSONObject.class, MainActivity.this, "apiCallback");
                }else if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    fTrans.replace(R.id.frgmCont, frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=energyfm";
            ...
            case R.id.button6:
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    fTrans.replace(R.id.frgmCont2,frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=nostalgiefm";
                    aq.ajax(apiURL, JSONObject.class, MainActivity.this, "apiCallback");
                }else if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    fTrans.replace(R.id.frgmCont, frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=nostalgiefm";
            ...
            case R.id.button7:
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    fTrans.replace(R.id.frgmCont2,frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=russianfm";
                    aq.ajax(apiURL, JSONObject.class, MainActivity.this, "apiCallback");
                }else if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    fTrans.replace(R.id.frgmCont, frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=russianfm";
            ...
            case R.id.button8:
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    fTrans.replace(R.id.frgmCont2,frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=radiometro";
                    aq.ajax(apiURL, JSONObject.class, MainActivity.this, "apiCallback");
                }else if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    fTrans.replace(R.id.frgmCont, frag1);
                    String apiURL = "http://kivvi.kz/api/radio/info?stream=radiometro";
    ...
    try {
        ...
        aq.id(R.id.textStation).text(Html.fromHtml(description));
